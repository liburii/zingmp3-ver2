...
const app = {
    ...
    durationList: JSON.parse(localStorage.getItem(DURATION_STORAGE_KEY) || `[
        ["04:14","03:23","04:00","03:01","04:57","03:24","06:05","03:20","02:35","15:13","02:56","02:53","03:01","04:39","10:21", "03:26","03:16","03:20","02:52","05:37","02:45"],
        ["04:04","03:45","03:46","02:52","03:04","03:03","03:24","03:31","02:29","04:13","04:28","03:07","02:30","04:46","03:30","03:35","03:25","03:49","04:57","03:13"],
        ["02:38","07:20","03:00","02:37","03:25","03:43","03:12","03:07","02:54","03:27","03:55","03:33","03:44","03:36","03:11","04:11"],
        ["04:00","04:09","03:30","03:06","03:44","04:00","05:40","03:28","05:49","05:09","06:21","11:45","03:01","56:55","02:02","31:15","04:26"]
    ]`),
                ...
                <div class="charts__container">
                    <div class="grid">
                        ...
                        <div class="charts__expand">
                            <button class="button charts__expand-btn">Xem tất cả</button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="story__item-container">
                                ...
                                <div class="story__item-action">
                                    <div class="action-btn story-btn--heart">
                                        <i class="btn--icon icon--heart bi bi-heart"></i>
                                        <span class="action__number">${Math.floor(Math.random() * 1000000)}</span>
                                    </div>
                                    <div class="action-btn story-btn--comment">
                                        <i class="btn--icon icon--comment bi bi-chat-dots"></i>
                                        <span class="action__number">${Math.floor(Math.random() * 10000)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    handleEvents: function() {
        ...
        sidebarSubnavItems.forEach(subnavItem => {
            subnavItem.onclick = (e) => {
                showNotificationToast('Tính năng này sẽ sớm ra mắt !')
            }
        })
